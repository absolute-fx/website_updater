    ...
    getUpdateFile(versionInfo) {
        ...
        return (0, (_bluebirdLst || _load_bluebirdLst()).coroutine)(function* () {
            ...
            return {
                ...
                url: filePath.startsWith("http:") || filePath.startsWith("https:") ? filePath : (_url || _load_url()).format(Object.assign({}, _this2.baseUrl, { pathname: _path.posix.resolve(_this2.baseUrl.pathname || "/", filePath) })),
